...
$(document).ready(function () {
	...
	var eventSlideTriggerExists = false;
	if ($('.eventSlideTrigger').length > 0) {
		eventApp.refresh(null, false);
		eventSlideTriggerExists = true;
	}

	window.onload = function () {
		main();
	
		slideControl.modules.push(eventSlideCollection);
		slideControl.modules.push(pictureCollection);
		slideControl.modules.push(video);
		...
		function cycleControl () {
			...
			console.log('iterations >= maxIterations', iterations, maxIterations);
