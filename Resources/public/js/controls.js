  ...
  function main () {
	...
	if (typeof $('#slides').data('scalingAllowed') == 'boolean') {
		obeyOnresize = $('#slides').data('scalingAllowed');
	}
	...
	console.log('wondow.load triggered');
  }

  function scanForSlides () {
  ...
  function getDetails(idx) {
    var s = document.querySelector("#slides > section:nth-of-type("+ idx +")");
  ...
  function toggleContent() {
    var s = document.querySelector("#slides > section[aria-selected]");
    if (s) {
  ...
  function setSlide() {
    var old = document.querySelector("#slides > section[aria-selected]");
    var next = document.querySelector("#slides > section:nth-of-type("+ idx +")");
    if (old) {
